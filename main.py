...
import functional.feeder.dataset.KineticsFull as K
import functional.feeder.dataset.KineticsLoader as KL
...
# Data options
parser.add_argument('--datapath', default='/datasets/kinetics_jpg/',
                    help='Data path for Kinetics')
parser.add_argument('--csvpath', default='datas/kinetics.csv',
...
def main():
    ...
    TrainData = K.dataloader(args.csvpath)
